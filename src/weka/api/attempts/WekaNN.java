...
public class WekaNN {
	...
	public static void main(String[] args) {
		...
		"-L "+0.1 		//learning rate
                +" -M "+0 		//momentum
                +" -N "+1000	//epoch. the larger epoch, the better results.
                +" -V "+0 		//validation
                +" -S "+0 		//seed
                +" -E "+0 		//error
                +" -H "+"100"; 		//hidden nodes. e.g. use "3,3" for 2 level hidden layer with 3 nodes
		
		String fileType = "arff"; //available file types: arff, txt
		String dumpLocation = "/Users/faisal"; //specify where you want to store the binary network
	...
	public static Instances retrieveHistoricalData(String fileType){
		...
		try{
			...
			if("arff".equals(fileType)){
				...
				String historicalDataPath = System.getProperty("user.dir")+"//Data//training.arff";
				...
				String historicalDataPath = System.getProperty("user.dir")+"//Data//training.txt";
				...
				while (line != null) {
					...
					if(line != null){
						...
						Instance trainingItem = new DenseInstance(items.length);
